...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'kicker': 'm-0 flex items-center gap-3 text-[0.7rem] font-bold uppercase tracking-[0.12em] text-orange before:content-[""] before:block before:w-6 before:h-px before:bg-orange',
