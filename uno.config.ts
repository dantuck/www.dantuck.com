...
export default defineConfig({
  ...
  shortcuts: {
    'nav-tagline': 'text-[0.75rem] uppercase tracking-[0.08em] text-site-text/60 no-underline hover:text-orange-text',
    'max-content': 'max-w-[min(800px,calc(100vw-3rem))] mx-auto',
    'article-content': 'max-w-[min(1120px,calc(100vw-3rem))] mx-auto',
    'kicker': 'm-0 flex items-center gap-3 text-[0.7rem] font-bold uppercase tracking-[0.12em] text-orange-text before:content-[""] before:block before:w-6 before:h-px before:bg-orange',
